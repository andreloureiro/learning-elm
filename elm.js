...
Elm.DrawCircle = Elm.DrawCircle || {};
Elm.DrawCircle.make = function (_elm) {
   "use strict";
   _elm.DrawCircle = _elm.DrawCircle || {};
   if (_elm.DrawCircle.values)
   return _elm.DrawCircle.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "DrawCircle",
   $Basics = Elm.Basics.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var moveCircles = F2(function (circle,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return A2($Graphics$Collage.move,
              ...
              circle);}
         _U.badCase($moduleName,
         "on line 15, column 3 to 21");
      }();
   });
   var createCircle = F2(function (color,
   size) {
      return $Graphics$Collage.filled(color)($Graphics$Collage.circle(size));
   });
   var circlesGroup = F2(function (color,
   data) {
      return function () {
         var circleInstance = A2(createCircle,
         color,
         5);
         var createGroupInstance = function (_v4) {
            return function () {
               switch (_v4.ctor)
               {case "_Tuple2":
                  return A2(moveCircles,
                    circleInstance,
                    {ctor: "_Tuple2"
                    ,_0: _v4._0
                    ,_1: _v4._1});}
               _U.badCase($moduleName,
               "on line 21, column 7 to 39");
            }();
         };
         return A2($List.map,
         createGroupInstance,
   ...
   var drawCircles = F3(function (position,
   color,
   data) {
      return $Graphics$Collage.moveX(position)($Graphics$Collage.group(A2(circlesGroup,
      color,
      data)));
   });
   _elm.DrawCircle.values = {_op: _op
...
Elm.DrawGraph = Elm.DrawGraph || {};
Elm.DrawGraph.make = function (_elm) {
   "use strict";
   _elm.DrawGraph = _elm.DrawGraph || {};
   if (_elm.DrawGraph.values)
   return _elm.DrawGraph.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "DrawGraph",
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $DrawCircle = Elm.DrawCircle.make(_elm),
   $DrawLine = Elm.DrawLine.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var data3 = _L.fromArray([{ctor: "_Tuple2"
                             ,_0: 100
                             ,_1: 50}
                            ,{ctor: "_Tuple2"
                             ,_0: 200
                            ...
                            ,{ctor: "_Tuple2"
                             ,_0: 1000
                             ,_1: 10}]);
   var data2 = _L.fromArray([{ctor: "_Tuple2"
                             ,_0: 100
                             ,_1: 40}
                            ,{ctor: "_Tuple2"
                             ,_0: 200
                            ...
                            ,{ctor: "_Tuple2"
                             ,_0: 1000
                             ,_1: 10}]);
   var data1 = _L.fromArray([{ctor: "_Tuple2"
                             ,_0: 100
                             ,_1: 30}
                            ,{ctor: "_Tuple2"
                             ,_0: 200
                            ...
                            ,{ctor: "_Tuple2"
                             ,_0: 1000
                             ,_1: 100}]);
   var init = F2(function (w,h) {
      return function () {
         var posX = 0 - $Basics.toFloat(w) / 2;
         return A3($Graphics$Collage.collage,
         w,
         h,
         _L.fromArray([A3($DrawLine.drawPath,
                      posX,
                      $Color.purple,
                      data1)
                      ,A3($DrawLine.drawPath,
                      posX,
                      $Color.red,
                      data2)
                      ,A3($DrawLine.drawPath,
...
Elm.DrawLine = Elm.DrawLine || {};
Elm.DrawLine.make = function (_elm) {
   "use strict";
   _elm.DrawLine = _elm.DrawLine || {};
   if (_elm.DrawLine.values)
   return _elm.DrawLine.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var createPath = function (data) {
      return $Graphics$Collage.path(data);
   };
   var lineStyle = function (color) {
      return $Graphics$Collage.solid(color);
   };
   var drawPath = F3(function (position,
   color,
   data) {
      return $Graphics$Collage.moveX(position)(A2($Graphics$Collage.traced,
      lineStyle(color),
      createPath(data)));
   });
   _elm.DrawLine.values = {_op: _op
                          ,lineStyle: lineStyle
...
Elm.ResolveGraph = Elm.ResolveGraph || {};
Elm.ResolveGraph.make = function (_elm) {
   "use strict";
   _elm.ResolveGraph = _elm.ResolveGraph || {};
   if (_elm.ResolveGraph.values)
   return _elm.ResolveGraph.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "ResolveGraph",
   $Basics = Elm.Basics.make(_elm),
   $DrawGraph = Elm.DrawGraph.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   $Window.width),
   $Window.height);
   _elm.ResolveGraph.values = {_op: _op
                              ,main: main};
   return _elm.ResolveGraph.values;
};
